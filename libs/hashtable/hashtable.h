...
//  hashtable_apply : applique fun sur chacun des couples (clé, valeur) 
//    de la table ht de la manière suivante fun(acc, clé, valeur). La fonction 1 
//    en cas de succès ou -1 si ht ou fun vaut NULL.
extern int hashtable_apply(hashtable *ht, void *acc,
    void fun (void *, const void *, const void *));
